 ...
 * @author ma_fe
 */
public class EditFicFormPanel extends javax.swing.JPanel {

    private FicListPanel list;
    
    public EditFicFormPanel(FicListPanel list,Fanfiction fic) {
        this.list = list;
        initComponents();
        headerLbl.setText("Update");
        titleTF.setText(fic.getName());
        tagsTA.setText(fic.getStrTags());
    }
